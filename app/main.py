...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5173", "https://wblog-fe.vercel.app", "https://wblog-5kd4xpgt5-vishwagovula07-gmailcoms-projects.vercel.app"],  # list of allowed origins
